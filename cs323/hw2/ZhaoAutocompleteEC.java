...
public class ZhaoAutocompleteEC extends Trie<List<String>> implements IAutocomplete<List<String>>{
		...
		*/
		...
		do{
			...
			if (node.isEndState() && (!list.contains(word.getKey())))
			{
				...
				//make sure list is at most of the length of 20
				truncate(list);
			}
	...
	public void pickCandidate(String prefix, String candidate)
	{
    	...
    	//make the candidate the top of the list
