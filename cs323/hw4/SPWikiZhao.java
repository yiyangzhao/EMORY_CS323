 ...
 */
public class SPWikiZhao
{
	List<String> titles;
	int[][] links;
	
	public SPWikiZhao(InputStream inTitles, InputStream inLinks) throws Exception
	{
		...
		System.out.println("Finding path from "+source +" : "+ titles.get(source)+" to "+target+" : "+titles.get(target));
	...
	{
		final String TITLE_FILE = "/Users/Alan/Desktop/cs323hw4/wiki-titles-small.txt";
		final String LINK_FILE  = "/Users/Alan/Desktop/cs323hw4/wiki-links-small.txt";
		
		new SPWikiZhao(new FileInputStream(TITLE_FILE), new FileInputStream(LINK_FILE));
	}
}